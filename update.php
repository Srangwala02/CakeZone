...
<head>
    ...
    <script src="https://kit.fontawesome.com/4939508d0a.js" crossorigin="anonymous"></script>
</head>
...
<body>
    ...
    <nav class="navbar navbar-expand-lg bg-dark navbar-dark shadow-sm py-3 py-lg-0 px-3 px-lg-0">
        ...
        <div class="collapse navbar-collapse" id="navbarCollapse">
            <div class="navbar-nav ms-auto mx-lg-auto py-0">
                ...
                <a href="../order.php" class="nav-item nav-link" id="admin"><i class="fas fa-user-alt"></i></a>
            </div>
        </div>
    </nav>
    <!-- Navbar End -->
    ...
    <!-- Footer Start -->
<div class="container-fluid bg-dark bg-img text-secondary" style="margin-top: 75px">
        <div class="container">
            <div class="row gx-5">
