...
<body onload="showPop()">
        ...
        <div class="card">
            <div class="container-fliud">
                <div class="wrapper row">
                    <?php
                    // $hello= 'hello';
                    // $hello= '<script type="text/javascript">show();</script>';
                    // echo $hello;
                    //    $hello= $_COOKIE["x"];

                    $sql = "select * from `product` where id='p102'";
                    ...
                    <div class="details col-md-6">
                        <h3 class="product-title"><?= $res['name'] ?></h3>
                        ...
                        <div class="action">
                            <form action="manage_cart.php" method="POST">
                                <button class="add-to-cart btn btn-default" name="Add_To_Cart" type="submit">add to cart</button>
    ...
    <!-- pop up 2 -->
    <!-- <div class="container" id="popUp2" style="visibility:hidden">
    <span onclick="getID()" class="close" title="Close">&times;</span>
        <div class="card">
            <div class="container-fliud">
                <div class="wrapper row">
