...
<body onload="show()">
                        ...
                        <div class="action">
                            <form action="menu.php?action=add&pid=<?php echo $res["id"]; ?>" method="POST">
                                ...
                                <div class="cart-action">
                                    <input type="button" onclick="removeItem(<?php echo $index ?>)" value="-"><input type="text" value="1" class="product-quantity" name="quantity" id=<?php echo $index ?> /><input type="submit" value="Add to Cart" class="add-to-cart btn btn-default" /><input type="button" onclick="addItem(<?php echo $index ?>)" value="+">
                                </div><?php $index++ ?>
    ...
    <script>
        function insert() {
            ...
            $sql = "insert into `cart` (`id`, `productId`, `userId`, `quantity`) values('$id', '$hello', '$userId', '$quantity')";
